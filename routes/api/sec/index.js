...
//const Sec = require("./sec.model.js");
...
/*router.get('/passrecovery', async (req, res, next)=>{  
  mailSender(
    "kateringosorto08@gmail.com",
    "Recuperar Credenciales",
    '<h1><cenert>Recuperar Contraseña</center></h1><p>Para completar el restablecimiento de su cuenta haga click en el <a href="http://localhost:3000/recoverypass">enlace</p><p>Este enlace solo será valido por 20 minutos.</p>'
  );
